...
the workflow developer, who is in charge of developing and deploying the workflow in the computing infrastructure, and then the
...
:numref:`fig_hpcwaas` shows how these two roles interact with the proposed HPCWaaS methodology. Workflow developers implement
...
execution. This is achieved by interacting with the Development Interface offered by the Alien4Cloud tool to describe workflows as a
